...
public class Common {
    ...
    /**
     * @param inputStream
     * @param unicode     编码 GBK 或 UTF-8
     * @return
     * @throws Exception
     */
    public static String readHtml(InputStream inputStream, String unicode) throws Exception {
        InputStreamReader input = new InputStreamReader(inputStream, unicode);
