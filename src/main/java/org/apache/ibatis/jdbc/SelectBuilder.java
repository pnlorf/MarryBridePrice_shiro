...
public class SelectBuilder {
  ...
  private static final ThreadLocal<org.apache.ibatis.jdbc.SQL> localSQL = new ThreadLocal<org.apache.ibatis.jdbc.SQL>();
  ...
  public static void RESET() {
    localSQL.set(new org.apache.ibatis.jdbc.SQL());
  }
