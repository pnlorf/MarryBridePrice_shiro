...
public class Reflector {
	...
	private static final Map<Class<?>, org.apache.ibatis.reflection.Reflector> REFLECTOR_MAP = new ConcurrentHashMap<Class<?>, org.apache.ibatis.reflection.Reflector>();
	 ...
	 */
	public static org.apache.ibatis.reflection.Reflector forClass(
			Class<?> clazz) {
		if (classCacheEnabled) {
			// synchronized (clazz) removed see issue #461
			org.apache.ibatis.reflection.Reflector cached = REFLECTOR_MAP
					.get(clazz);
			if (cached == null) {
				cached = new org.apache.ibatis.reflection.Reflector(
						clazz);
				REFLECTOR_MAP.put(
						clazz, cached);
			}
			...
			return new org.apache.ibatis.reflection.Reflector(clazz);
		}
	}

	public static void setClassCacheEnabled(
			boolean classCacheEnabled) {
		org.apache.ibatis.reflection.Reflector.classCacheEnabled = classCacheEnabled;
	}
