...
public class MetaObject {
	...
	public static org.apache.ibatis.reflection.MetaObject forObject(
			Object object,
			ObjectFactory objectFactory,
			ObjectWrapperFactory objectWrapperFactory) {
		if (object == null) {
			...
			return new org.apache.ibatis.reflection.MetaObject(
					object,
					objectFactory,
	...
	public Object getValue(String name) {
		PropertyTokenizer prop = new PropertyTokenizer(
				name);
		if (prop.hasNext()) {
			org.apache.ibatis.reflection.MetaObject metaValue = metaObjectForProperty(prop
					.getIndexedName());
	...
	public org.apache.ibatis.reflection.MetaObject metaObjectForProperty(
			String name) {
