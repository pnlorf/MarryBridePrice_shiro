...
public class XMLMapperBuilder extends BaseBuilder {
  ...
  private void buildStatementFromContext(List<XNode> list, String requiredDatabaseId) {
    for (XNode context : list) {
      final org.apache.ibatis.builder.xml.XMLStatementBuilder statementParser = new org.apache.ibatis.builder.xml.XMLStatementBuilder(configuration, builderAssistant, context, requiredDatabaseId);
      try {
  ...
  private void parsePendingStatements() {
	  Collection<org.apache.ibatis.builder.xml.XMLStatementBuilder> incompleteStatements = configuration.getIncompleteStatements();
